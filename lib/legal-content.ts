...
const en: LegalLocaleData = {
  ...
  agbKeyB2bOnly: "ClinicSlotHub is exclusively for commercial users (medical and therapy practices). Consumer use is excluded.",
...
const fr: LegalLocaleData = {
  ...
  agbKeyB2bOnly: "ClinicSlotHub est exclusivement destiné aux utilisateurs professionnels (cabinets médicaux et thérapeutiques). L'utilisation par des consommateurs est exclue.",
...
const es: LegalLocaleData = {
  ...
  agbKeyB2bOnly: "ClinicSlotHub está destinado exclusivamente a usuarios comerciales (consultas médicas y terapéuticas). El uso por consumidores está excluido.",
...
const ar: LegalLocaleData = {
  ...
  agbKeyB2bOnly: "ClinicSlotHub مخصص حصرياً للمستخدمين التجاريين (عيادات طبية وعلاجية). يُستثنى من ذلك المستهلكون الأفراد.",
...
const pt: LegalLocaleData = {
  ...
  agbKeyB2bOnly: "ClinicSlotHub destina-se exclusivamente a utilizadores comerciais (consultórios médicos e de terapia).",
...
const ru: LegalLocaleData = {
  ...
  agbKeyB2bOnly: "ClinicSlotHub предназначен исключительно для коммерческих пользователей (медицинские и терапевтические клиники).",
...
const zh: LegalLocaleData = {
  ...
  agbKeyB2bOnly: "ClinicSlotHub 专供商业用户（医疗和治疗诊所）使用。",
...
const hi: LegalLocaleData = {
  ...
  agbKeyB2bOnly: "ClinicSlotHub विशेष रूप से व्यावसायिक उपयोगकर्ताओं (चिकित्सा और थेरेपी क्लीनिक) के लिए है।",
...
const bn: LegalLocaleData = {
  ...
  agbKeyB2bOnly: "ClinicSlotHub শুধুমাত্র বাণিজ্যিক ব্যবহারকারীদের জন্য।",
