...
Bevor PraxisFlow für weitere Praxen geöffnet wird, soll eine einzige, sorgfältig ausgewählte
...
- In der PraxisFlow-Oberfläche unter `/dashboard/patients` Testpatienten anlegen.
