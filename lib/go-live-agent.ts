...
function sectionC(): GoLiveSection {
  ...
  checks.push({
    ...
    status: "ready",
    note: "Kontaktformular ist eingehend (Praxis → ClinicSlotHub). Kein ausgehender automatischer Outreach.",
  });
...
function sectionJ(): GoLiveSection {
  ...
  const brandConfigured =
    ...
    BRAND_NAME === "ClinicSlotHub" &&
    typeof BRAND_TEAM_NAME === "string" &&
    BRAND_TEAM_NAME.includes("ClinicSlotHub") &&
