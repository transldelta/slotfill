      ...
      <div className="mt-8 space-y-8 text-sm text-slate-700 dark:text-slate-300">
        ...
        <section>
          ...
          <div className="mt-2 space-y-2 leading-relaxed">
            <p>
              ...
              nachfolgend „Anbieter&ldquo;) und dem Nutzer der Plattform (nachfolgend „Praxis&ldquo; oder
              „Nutzerin/Nutzer&ldquo;).
            </p>
            <p>
        ...
        <section>
          ...
          <div className="mt-2 space-y-2 leading-relaxed">
            ...
            <p>
              (4) <span className="rounded bg-amber-100 px-1 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300">
                [zu prüfen]
              </span>{" "}
