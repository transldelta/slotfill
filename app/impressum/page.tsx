...
/**
 * Impressum gemäß § 5 DDG (Digitale-Dienste-Gesetz).
 *
 * Persönliche Daten des Anbieters erscheinen ausschließlich auf dieser Seite –
 * nicht in automatischer Kommunikation, Marketing oder Trial-Mails.
 *
 * ENTWURF – vor Veröffentlichung bitte durch einen Rechtsanwalt prüfen lassen.
 */
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="mt-8 space-y-6 text-sm text-slate-700 dark:text-slate-300">
        ...
        {/* Kein persönlicher Name in automatischer Kommunikation – interner Hinweis */}
        <section className="rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800/50">
          <p className="text-xs text-slate-500 dark:text-slate-400">
            ...
            „SlotFill Team&ldquo; als Absender verwendet.
          </p>
        </section>
