 ...
 *
 * Slotfill wird derzeit nur für ausgewählte internationale Märkte geprüft und
...
const EN: MarketScopeText = {
  ...
  agbBody: [
    "Slotfill is currently not intended for users, patients, clinics, practices or healthcare providers located in the European Union, the European Economic Area, Europe, the United States, Canada, the United Kingdom, Australia, New Zealand or other highly regulated western healthcare markets.",
    "Requests, registrations or use from these countries or regions may be rejected or not processed. Slotfill is currently reviewed and provided only for selected international markets. Availability depends on the relevant country, local legal requirements, technical feasibility and prior internal approval.",
    "Slotfill is not a medical advice service, emergency service or medical record system. Appointments and appointment requests are reviewed and confirmed by the relevant practice or clinic.",
  ],
  privacyTitle: "Notice on territorial scope",
  privacyBody:
    "Slotfill is currently not directed at persons or organizations in the EU, EEA, Europe, the United States, Canada, the United Kingdom, Australia or New Zealand. Requests from unsupported jurisdictions may be rejected. If personal data is nevertheless submitted, it will be processed only within the scope of the existing privacy information and technical capabilities.",
  privacyNotice:
  ...
  imprintBody:
    'Slotfill is currently not offered to users, clinics, practices or patients in the EU, EEA, Europe, the United States, Canada, the United Kingdom, Australia or New Zealand. Further details are provided in the "Territorial scope" section of the Terms.',
  bookingNotice:
    "Notice: Slotfill is currently available only for selected markets. Requests from unsupported jurisdictions may be rejected.",
...
const DE: MarketScopeText = {
  ...
  imprintBody:
    "Slotfill richtet sich derzeit nicht als Angebot an Nutzer, Praxen, Kliniken oder Patienten in der EU, im EWR, Europa, den USA, Kanada, dem Vereinigten Königreich, Australien oder Neuseeland. Weitere Einzelheiten enthält der Abschnitt „Räumlicher Leistungsbereich“ in den AGB.",
  bookingNotice:
    "Hinweis: Slotfill ist derzeit nur für ausgewählte Märkte verfügbar. Anfragen aus nicht unterstützten Ländern können abgelehnt werden.",
...
const FR: MarketScopeText = {
  ...
  agbBody: [
    "Slotfill ne s'adresse actuellement pas aux utilisateurs, patients, cliniques, cabinets ou prestataires de santé situés dans l'Union européenne, l'Espace économique européen, l'Europe, les États-Unis, le Canada, le Royaume-Uni, l'Australie, la Nouvelle-Zélande ou d'autres marchés de santé occidentaux fortement réglementés.",
    "Les demandes, inscriptions ou utilisations provenant de ces pays ou régions peuvent être refusées ou non traitées. Slotfill est actuellement examiné et proposé uniquement pour des marchés internationaux sélectionnés. La disponibilité dépend du pays concerné, des exigences légales locales, de la faisabilité technique et d'une autorisation interne préalable.",
    "Slotfill n'est pas un service de conseil médical, un service d'urgence ni un système de dossiers médicaux. Les rendez-vous et les demandes de rendez-vous sont examinés et confirmés par le cabinet ou la clinique concernés.",
  ],
  privacyTitle: "Avis sur le champ d'application territorial",
  privacyBody:
    "Slotfill ne s'adresse actuellement pas aux personnes ou organisations situées dans l'UE, l'EEE, l'Europe, les États-Unis, le Canada, le Royaume-Uni, l'Australie ou la Nouvelle-Zélande. Les demandes provenant de juridictions non prises en charge peuvent être refusées. Si des données personnelles sont néanmoins transmises, elles ne sont traitées que dans le cadre des informations de confidentialité existantes et des possibilités techniques.",
  privacyNotice:
  ...
  imprintBody:
    "Slotfill n'est actuellement pas proposé aux utilisateurs, cliniques, cabinets ou patients dans l'UE, l'EEE, l'Europe, les États-Unis, le Canada, le Royaume-Uni, l'Australie ou la Nouvelle-Zélande. Pour plus de détails, voir la section « Champ d'application territorial » des conditions.",
  bookingNotice:
    "Avis : Slotfill est actuellement disponible uniquement dans certains marchés sélectionnés. Les demandes provenant de juridictions non prises en charge peuvent être refusées.",
...
const ES: MarketScopeText = {
  ...
  agbBody: [
    "Slotfill actualmente no está dirigido a usuarios, pacientes, clínicas, consultorios o proveedores de salud ubicados en la Unión Europea, el Espacio Económico Europeo, Europa, los Estados Unidos, Canadá, el Reino Unido, Australia, Nueva Zelanda u otros mercados de salud occidentales altamente regulados.",
    "Las solicitudes, registros o usos desde estos países o regiones pueden ser rechazados o no procesados. Slotfill actualmente se revisa y se ofrece solo para mercados internacionales seleccionados. La disponibilidad depende del país correspondiente, los requisitos legales locales, la viabilidad técnica y una aprobación interna previa.",
    "Slotfill no es un servicio de asesoramiento médico, un servicio de emergencia ni un sistema de historiales médicos. Las citas y las solicitudes de cita son revisadas y confirmadas por el consultorio o la clínica correspondiente.",
  ],
  ...
  imprintBody:
    "Slotfill actualmente no se ofrece a usuarios, clínicas, consultorios o pacientes en la UE, el EEE, Europa, los Estados Unidos, Canadá, el Reino Unido, Australia o Nueva Zelanda. Más detalles en la sección «Ámbito territorial» de los términos.",
  bookingNotice:
    "Aviso: Slotfill está disponible actualmente solo en mercados seleccionados. Las solicitudes desde jurisdicciones no admitidas pueden ser rechazadas.",
...
const PT: MarketScopeText = {
  ...
  imprintBody:
    "O Slotfill atualmente não é oferecido a utilizadores, clínicas, consultórios ou pacientes na UE, no EEE, na Europa, nos Estados Unidos, no Canadá, no Reino Unido, na Austrália ou na Nova Zelândia. Mais detalhes na secção «Âmbito territorial» dos termos.",
  bookingNotice:
    "Aviso: o Slotfill está atualmente disponível apenas em mercados selecionados. Pedidos de jurisdições não suportadas podem ser recusados.",
