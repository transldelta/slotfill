...
PraxisFlow kostenlos testen: Jetzt 14 Tage testen und sehen, wie die Wartelisten-Verwaltung einfacher wird.`,
  },
...
PraxisFlow unterstützt genau diesen Prozess: Bei einer Terminlücke werden passende Patienten aus der Warteliste vorbereitet, und die Praxis kann mit einem Klick einen sicheren Link an ausgewählte Personen versenden.

Jetzt ausprobieren: Testen Sie PraxisFlow 14 Tage kostenlos.`,
  },
...
Was PraxisFlow in diesem Kontext leistet

PraxisFlow ist als datenschutzbewusstes Tool konzipiert: Patienten können nur dann über digitale Kanäle kontaktiert werden, wenn sie zuvor eingewilligt haben (opt-in). Der Standardmodus arbeitet ohne automatischen Nachrichtenversand – die Praxis behält die Kontrolle darüber, wer kontaktiert wird.

Hinweis: Die Verwendung von PraxisFlow ersetzt keine individuelle datenschutzrechtliche Prüfung. Jede Praxis ist verpflichtet, den Einsatz von Software für die Patientenkommunikation eigenverantwortlich zu prüfen.
...
Kontakt aufnehmen: Bei Fragen zu PraxisFlow und dem Einsatz in Ihrer Praxis freuen wir uns auf Ihre Nachricht.`,
  },
];
