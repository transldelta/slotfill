...
export default function TerminBuchenPage() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col"
      style={{ backgroundColor: "var(--color-bg)" }}
      data-booking-copy-version="manual-confirmation-only-v2"
    >
      {/* Unsichtbarer Live-Parity-Marker (kein Fake-Claim, stört keine UI). */}
      <span className="sr-only" data-booking-copy-version="manual-confirmation-only-v2">
        Manual confirmation copy version active
      </span>
      <header
        className="border-b px-4 py-3"
        style={{
      ...
      <main className="mx-auto w-full max-w-lg flex-1 px-4 py-12">
        ...
        >
          ...
          <p className="mt-1 text-slate-600 dark:text-slate-400">
            ...
            2.{" "}
            {locale === "de"
              ? "Die Praxis prüft Ihre Anfrage und bestätigt den Termin manuell. Es erfolgt keine automatische Terminbestätigung ohne Freigabe durch die Praxis."
              : "The practice reviews your request and confirms the appointment manually. There is no automatic appointment confirmation without approval by the practice."}
            <br />
