    ...
    <main className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="mt-8 space-y-8 text-sm text-slate-700 dark:text-slate-300">
        ...
        <section>
          ...
          <div className="mt-2 space-y-2 leading-relaxed">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Betreff: „AVV SlotFill&ldquo; – bitte Praxisname und Art der geplanten Datenverarbeitung
              kurz beschreiben.
            </p>
          </div>
        </section>
        ...
        <div className="flex gap-4 text-sm">
          ...
          <Link href="/agb" className="text-blue-600 hover:underline dark:text-blue-400">
            AGB →
          </Link>
          <Link href="/impressum" className="text-blue-600 hover:underline dark:text-blue-400">
            Impressum →
          </Link>
        </div>
