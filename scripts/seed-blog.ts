...
const LEGACY_POSTS = [
  {
    slug: "willkommen-bei-clinicslothub",
    title: "Willkommen bei ClinicSlotHub",
    excerpt: "Wie ClinicSlotHub Ihrer Praxis hilft, kurzfristige Terminlücken zu füllen.",
    content:
      "ClinicSlotHub verbindet Ihre Warteliste mit Ihren Terminen. Fällt ein Termin aus, werden passende Patienten über einen sicheren Link informiert – so füllt sich die Lücke oft noch am selben Tag.",
  ...
  },
  {
    ...
    content:
      "1. Pflegen Sie Ihre Warteliste. 2. Markieren Sie ausgefallene Termine. 3. Lassen Sie ClinicSlotHub die passenden Patienten vorbereiten.",
