...
const LEGACY_POSTS = [
  {
    ...
    content:
      "PraxisFlow verbindet Ihre Warteliste mit Ihren Terminen. Fällt ein Termin aus, werden passende Patienten über einen sicheren Link informiert – so füllt sich die Lücke oft noch am selben Tag.",
  ...
  },
  {
    ...
    content:
      "1. Pflegen Sie Ihre Warteliste. 2. Markieren Sie ausgefallene Termine. 3. Lassen Sie PraxisFlow die passenden Patienten vorbereiten.",
