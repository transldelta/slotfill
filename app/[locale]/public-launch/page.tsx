...
const HUB: Record<string, HubContent> = {
  de: {
    ...
    whatDesc: "ClinicSlotHub ist eine browserbasierte Plattform für Kliniken in wachstumsstarken Gesundheitsmärkten. Jede Klinik erhält einen eigenen öffentlichen Anfrage-Link – teilbar via WhatsApp, Website, E-Mail oder QR-Code. Patienten stellen darüber eine Anfrage, ohne sich anzumelden. Die Klinik prüft Anfragen direkt im Dashboard. WhatsApp-, Telefon- und Rezeptions-Fallback bleiben in der Hand der Klinik.",
    forWhom: "Für wen?",
    forWhomItems: [
      ...
      "Zahnarztpraxen",
      "Kliniken in wachstumsstarken Gesundheitsmärkten",
    ],
    ...
    statusNote: "Aktueller Status: Early Access · Ehrliches Produkt · Feedback willkommen · Keine erfundenen Zahlen",
    ...
    ogDesc: "Alles über ClinicSlotHub: Was es ist, für wen, wie testen. Mehrsprachig für Kliniken in wachstumsstarken Gesundheitsmärkten.",
  },
  en: {
    dir: "ltr",
    ...
    whatDesc: "ClinicSlotHub is a browser-based platform for clinics in emerging healthcare markets. Each clinic gets its own public request link — shareable via WhatsApp, website, email or QR code. Patients submit a request without creating an account. The clinic reviews requests directly in the dashboard. WhatsApp, phone and reception fallback stay in the clinic's hands.",
    ...
    forWhomItems: [
      ...
      "Dental practices",
      "Clinics in emerging healthcare markets",
    ],
    ...
    statusNote: "Current status: Early access · Honest product · Feedback welcome · No invented numbers",
    ...
    ogDesc: "Everything about ClinicSlotHub: what it is, who it's for, how to try it. Multilingual for clinics in emerging healthcare markets.",
  },
};
