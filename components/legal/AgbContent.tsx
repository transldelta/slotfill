      ...
      {isDE && (
        <div className="mt-8 space-y-8 text-sm text-slate-700 dark:text-slate-300">
          ...
          <section>
            ...
            <div className="mt-2 space-y-2 leading-relaxed">
              <p>
                ...
                ClinicSlotHub (betrieben durch Brahim Ben Abla, Schlesier Straße 64, 76227 Karlsruhe –
              ...
              <p>
                (2) ClinicSlotHub richtet sich ausschließlich an gewerbliche Nutzerinnen und Nutzer
          ...
          <section>
            ...
            <div className="mt-2 space-y-2 leading-relaxed">
              <p>
                (1) ClinicSlotHub ist eine webbasierte SaaS-Plattform zur Verwaltung von Patientenwarte­listen
          ...
          <section>
            ...
            <div className="mt-2 space-y-2 leading-relaxed">
              ...
              <p>
                ...
                (ClinicSlotHub) ist kein Reseller und haftet nicht für Kosten oder Ausfälle des
                externen Providers.
              </p>
              <p>
